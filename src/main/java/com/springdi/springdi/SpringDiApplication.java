...
import com.springdi.springdi.controllers.LanguageInjectedController;
...
public class SpringDiApplication {
	public static void main(String[] args) {
		...
		PrimaryBeanInjectedController primaryBean = (PrimaryBeanInjectedController) ctx
				.getBean("primaryBeanInjectedController");
		...
		System.out.println("---Language Injected Bean using Profiles---");
		LanguageInjectedController languageInjectedController = (LanguageInjectedController) ctx
				.getBean("languageInjectedController");
		System.out.println(languageInjectedController.getGreeting());
